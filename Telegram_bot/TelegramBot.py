...
bot = telegram.Bot(token='6854517132:AAF1EaphvNkm8rz-R8UtQQuAaExCfKn3yAQ') #Replace TOKEN with your token string

from telegram.ext import Updater, CommandHandler, MessageHandler, Filters

updater = Updater(token='6854517132:AAF1EaphvNkm8rz-R8UtQQuAaExCfKn3yAQ', use_context=True) #Replace TOKEN with your token string
